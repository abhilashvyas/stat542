...
# Set custom CSS for star ratings and layout
st.markdown(
    """
    <style>
        body {
...
with st.container():
    for _, row in sample_movies.iterrows():
        ...
        # Default to 3 stars and capture the rating
        ratings[movie_id] = st.select_slider(
            f"Rate {title}", 
            options=[1, 2, 3, 4, 5],
